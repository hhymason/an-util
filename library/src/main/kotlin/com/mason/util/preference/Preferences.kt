package com.mason.util.preference
...
abstract class Preferences(name: String, mode: Int = Context.MODE_PRIVATE) {
    ...
    val editor: SharedPreferences.Editor by editorDelegate
    ...
    private fun String.real(prop: KProperty<*>) = if (this === PROP_NAME) prop.name else this
