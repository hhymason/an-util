package com.mason.util.context
...
class ActivityTest {
    companion object {
        private const val PACKAGE_NAME = "com.mason.util.context"
        private const val ACTIVITY_NAME = "com.mason.util.context.TargetActivity"
